---
description: Check Server Logs - Read and categorize recent server log entries to find errors, warnings, and notable events.
---
...
1. Read the tail of each relevant log (last 200 lines via offset/limit or via run_command `Get-Content -Path <log_file> -Tail 200`)
