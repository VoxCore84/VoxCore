---
description: Validate SmartAI SQL - Validate a SmartAI SQL file against known enum values, deprecated types, and common mistakes
---
...
1. Read the SQL file
2. Write a Python script to `/tmp/` using `write_to_file` that:
...
3. Run the script using `run_command`
