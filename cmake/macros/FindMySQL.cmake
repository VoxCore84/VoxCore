...
if(MySQL_lib_WANTED AND MySQL_lib_FOUND)
  ...
  if(MYSQL_VERSION_DETECTION_RUN_OUTPUT)
    ...
    set(MYSQL_VERSION "8.0.45")
    set(MYSQL_FLAVOR "MySQL")
    message(WARNING "MySQL version detection program produced no output (missing DLL in PATH?), defaulting to MySQL ${MYSQL_VERSION}")
  endif()
