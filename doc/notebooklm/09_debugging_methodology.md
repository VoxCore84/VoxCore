...
Full debugging methodology for VoxCore investigations. CLAUDE.md has the gate definitions; this file has domain-specific recipes and patterns.

**This is a blocking pipeline with hard gates. Skipping a gate is equivalent to writing code that doesn't compile.**

**See also: "Completion Integrity — Anti-Theater Protocol" in CLAUDE.md** — mandatory rules against claiming completion without evidence. Added after session 114 revealed systematic false-completion reports.
